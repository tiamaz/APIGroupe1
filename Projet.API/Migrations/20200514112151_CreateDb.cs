    ...
    public partial class CreateDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_etudiantClasses", x => new { x.ClasseId, x.UserId });
                    table.ForeignKey(
                        name: "FK_etudiantClasses_classes_ClasseId",
                        column: x => x.ClasseId,
                        principalTable: "classes",
                        principalColumn: "ClasseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_etudiantClasses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_publications_classes_ClasseId",
                        column: x => x.ClasseId,
                        principalTable: "classes",
                        principalColumn: "ClasseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_etudiantClasses_UserId",
                table: "etudiantClasses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_publications_ClasseId",
                table: "publications",
                column: "ClasseId");
        }
